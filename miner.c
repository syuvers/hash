...
#define KROUND(rc) \
  ...
  t=s[0];s[0]=t^(~s[1]&s[2]);t=s[1];s[1]=t^(~s[2]&s[3]); \
  t=s[2];s[2]=t^(~s[3]&s[4]);t=s[3];s[3]=t^(~s[4]&s[0]); \
  t=s[4];s[4]=t^(~s[0]&s[1]);t=s[5];s[5]=t^(~s[6]&s[7]); \
  t=s[6];s[6]=t^(~s[7]&s[8]);t=s[7];s[7]=t^(~s[8]&s[9]); \
  t=s[8];s[8]=t^(~s[9]&s[5]);t=s[9];s[9]=t^(~s[5]&s[6]); \
  t=s[10];s[10]=t^(~s[11]&s[12]);t=s[11];s[11]=t^(~s[12]&s[13]); \
  t=s[12];s[12]=t^(~s[13]&s[14]);t=s[13];s[13]=t^(~s[14]&s[10]); \
  t=s[14];s[14]=t^(~s[10]&s[11]);t=s[15];s[15]=t^(~s[16]&s[17]); \
  t=s[16];s[16]=t^(~s[17]&s[18]);t=s[17];s[17]=t^(~s[18]&s[19]); \
  t=s[18];s[18]=t^(~s[19]&s[15]);t=s[19];s[19]=t^(~s[15]&s[16]); \
  t=s[20];s[20]=t^(~s[21]&s[22]);t=s[21];s[21]=t^(~s[22]&s[23]); \
  t=s[22];s[22]=t^(~s[23]&s[24]);t=s[23];s[23]=t^(~s[24]&s[20]); \
  t=s[24];s[24]=t^(~s[20]&s[21]);s[0]^=(rc);
static inline void keccak_f1600(uint64_t s[25]){
  uint64_t C0,C1,C2,C3,C4,D0,D1,D2,D3,D4,t;
  KROUND(RC[0])KROUND(RC[1])KROUND(RC[2])KROUND(RC[3])
  KROUND(RC[4])KROUND(RC[5])KROUND(RC[6])KROUND(RC[7])
  KROUND(RC[8])KROUND(RC[9])KROUND(RC[10])KROUND(RC[11])
  KROUND(RC[12])KROUND(RC[13])KROUND(RC[14])KROUND(RC[15])
  KROUND(RC[16])KROUND(RC[17])KROUND(RC[18])KROUND(RC[19])
  KROUND(RC[20])KROUND(RC[21])KROUND(RC[22])KROUND(RC[23])
}
